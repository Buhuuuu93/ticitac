...
//----------------------------------------------------------------------------------------------------------------------------------------//
//----------2 Optionen: Option 1= Zufälliges setzen auf ein freies Feld / Option 2= Zufälliger Win Weg (Auswahl welcher Weg)---------------//
//----------------------------------------------------------------------------------------------------------------------------------------//
...
async function PossibleWay0() {
    ...
    let GoOrNot = Math.floor(Math.random() * 9);
    console.log(GoOrNot);

    if (GoOrNot === 2 || GoOrNot === 5 || GoOrNot === 8) {
...
function InLastCasePlayStep() {
    ...
    for (let i = 0; i <= 9; i++) {
        ...
        if (i === 1 && PlayBtn1Win === 0) {
            SetIcon1();
            i = 10;
        } else if (i === 2 && PlayBtn2Win === 0) {
            SetIcon2();
            i = 10;
        } else if (i === 3 && PlayBtn3Win === 0) {
            SetIcon3();
            i = 10;
        } else if (i === 4 && PlayBtn4Win === 0) {
            SetIcon4();
            i = 10;
        } else if (i === 5 && PlayBtn5Win === 0) {
            SetIcon5();
            i = 10;
        } else if (i === 6 && PlayBtn6Win === 0) {
            SetIcon6();
            i = 10;
        } else if (i === 7 && PlayBtn7Win === 0) {
            SetIcon7();
            i = 10;
        } else if (i === 8 && PlayBtn8Win === 0) {
            SetIcon8();
            i = 10;
        } else if (i === 9 && PlayBtn9Win === 0) {
            SetIcon9();
            i = 10;
        }
    }
