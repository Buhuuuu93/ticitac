...
let WinDialogFlexItem3 = document.getElementById("WinDialogFlexItem3");
...
async function ResetPossibleWay() {
    PossibleOrNotWinWay0 = true;
    PossibleOrNotWinWay1 = true;
    PossibleOrNotWinWay2 = true;
    PossibleOrNotWinWay3 = true;
    PossibleOrNotWinWay4 = true;
    PossibleOrNotWinWay5 = true;
    PossibleOrNotWinWay6 = true;
    PossibleOrNotWinWay7 = true;
