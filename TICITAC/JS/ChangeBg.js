...
const ChangeitColor2 = document.getElementById("ChangeitColor2");
const ChangeitIcon2 = document.getElementById("ChangeitIcon2");
...
function addColorToStartDialog() {
    ...
    for (let i = 1; i < 11; i++) {
        ...
        if (i === WhichOneIsChoosed) {
            ...
            ChangeitColor2.classList.add(ArrayArroundColor1[i]);
            ChangeitIcon2.classList.add(ArrayArroundColor1[i]);
        }
    }
}
...
function RemoveColorToStartDialog() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        if (i === ActualColor) {
            ...
            ChangeitColor2.classList.remove(ArrayArroundColor[i]);
            ChangeitIcon2.classList.remove(ArrayArroundColor[i]);
        }
    }
}
...
//----------------------------------------------------------------------------------------------------------------------------------------//
//--------------------------------- Funktionen um die Background Color Auswahl auszuführen und entfernen ---------------------------------//
//-------------------------------------------------------Menu => Choose Icon X Or O ------------------------------------------------------//

let ChooseIconToChangeContainer2 = document.getElementById("ChooseIconToChangeContainer2");
let BtnXorO1 = document.getElementById("BtnXorO1");
let BtnXorO2 = document.getElementById("BtnXorO2");

async function addColorToMenuChooseIconXorO() {

    RemoveColorToMenuChooseIconXorO();
    ...
    for (let i = 1; i < 11; i++) {
        ...
        if (i === WhichOneIsChoosed) {
            ChooseIconToChangeContainer2.classList.add(ArrayBgColor1[i]);
            BtnXorO1.classList.add(ArrayArroundColor1[i]);
            BtnXorO2.classList.add(ArrayArroundColor1[i]);
        }
    }
}
...
function RemoveColorToMenuChooseIconXorO() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        if (i === ActualColor) {
            ChooseIconToChangeContainer2.classList.remove(ArrayBgColor[i]);
            BtnXorO1.classList.remove(ArrayArroundColor[i]);
            BtnXorO2.classList.remove(ArrayArroundColor[i]);
        }
    }
}
